...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-secondary/20">
      <div className="text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-bold text-primary font-montserrat">Servicios</h2>
